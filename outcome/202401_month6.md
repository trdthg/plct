...
- 调研开发板操作系统支持情况：[文档](https://gitee.com/plct_backup/weekly_trdthg/blob/main/doc/ruyi/board-os-support.md)
  - M5Stack STAMP-C3
  - ITE IT82XX2 series
  - ITE IT8XXX2 series
...
- console 模块 (负责和机器终端交互)
  ...
  - serial
    - Feature
      ...
      - 在全局 session 交互式运行脚本
      - 等待 tty 输出匹配文本
      - 捕获所有串口输出文本，包括系统 boot 阶段 [输出参考](https://gitee.com/plct_backup/weekly_trdthg/blob/main/doc/autotest/serial-log-example.txt)
  - vnc
    - Feature
      - 支持 vnc 连接，密码登录
      - 提供密码登录

...
- other
  ...
  - [euleceura.py](https://gitee.com/plct_backup/weekly_trdthg/blob/main/outcome/202403_week1/eulaceura.py) 编写 python 脚本自动启动 qemu 并配合测试
...
- 调研 ruyi device provision 命令自动化测试可行性
  ...
  - 需要解决如下问题
    ...
    - 烧录完需要重启
    - 重复烧录需要重新插一线，否则 fastboot 会报错[日志](https://gitee.com/plct_backup/weekly_trdthg/blob/main/outcome/202403_week4/failed.log)
